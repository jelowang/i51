...
i51KIT_DYNAMIC_KIT_DEF_TYPE(iBOOL, i51KitAmrEncoder, (iFILE inFile, iU8 *outBuffer, void (*process)(iU32 , iU32), void (*result)(iU32)) )
i51KIT_DYNAMIC_KIT_DEF_TYPE(iBOOL, i51KitAmrEncoderEx, (iU8 *inBuffer, iU32 inBuffLen, iU8 *outBuffer, void (*process)(iU32 , iU32), void (*result)(iU32)) )

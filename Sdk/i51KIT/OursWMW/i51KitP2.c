...
{	
	...
	iS32 i = 0, Temp = 0;
	// 上下左右、左上、右上、左下右下
	iS32 Xmultiplier[8] = {0,0,-1,1,-1,1,-1,1};
	iS32 Ymultiplier[8] = {-1,1,0,0,-1,-1,1,1};
	...
	if( V->X*Xmul <0 ) V->X = Xmul/AbsInt(Xmul)*300;
	if( V->Y*Ymul <0 ) V->Y = Ymul/AbsInt(Ymul)*300;

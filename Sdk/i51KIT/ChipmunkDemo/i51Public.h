...
#define PKIG_SCREEN_HORIZONTAL  //#define PKIG_SCREEN_HORIZONTAL  //横屏  PKIG_SCREEN_VERTICAL 竖屏  
...
#define PKIG_SCREEN_240X320

#define AUDIO_PLAYER_MIDI_NUMS  (4)  //midi播放器的数目
#define AUDIO_PLAYER_WAV_NUMS   (0)  //wav播放器的数目    //注意midi_nums + wav_nums <= 5

#define GAME_DIR       "AngryBird"       //游戏目录
#define IMAGE_RESOURCE_VERSION  0x01    //图片版本

/* game */
//#define GAME_KIT_VERSION (13)   //game.kit的版本号，每次更新需更改
//#define GAME_KIT_NUM   1            //kit的个数
//#define GAME_KIT       {"cf.kit"}   //游戏kit
#define GAME_RESOURCE_NUM   1   //re的个数
//#define GAME_RESOURCE  {"cf.re"}    //游戏资源
#define  CONTAINER_NAMES      {"game.container"}  //容器名字
//#define  RESOURCE_IMAGE_NUMS  {11}   //每个资源文件的图片数量
//
//#define GAME_PACKAGE_URL    "app://%s/%d/cf/"    //服务器上下载的游戏url，需要修改最后的cf，改为你自己的包名
...
//
//#define KIT_GAME_PATH      L"CutFruit\\cf.kit"       //kit的路径
//#define KIT_INSTALL_PATH   L"CutFruit\\install.kit"

#ifdef GAME_LOGO
#define INSTALL_RESOURCE_IMAGE_NUMS  {3, 17}   //install.re里的图片数
#else
#define INSTALL_RESOURCE_IMAGE_NUMS  {2, 17}
#endif

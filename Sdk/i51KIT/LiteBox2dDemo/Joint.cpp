...
void Joint::Set(Body* b1, Body* b2, const Vec2& anchor)
{
	...
	Rot1.Mat22_1(body1->rotation);
	Rot2.Mat22_1(body2->rotation);
...
Mat22 K3;
Mat22 K ;//= K1 + K2 + K3;
static Vec2 p1;// = body1->position + r1;
static Vec2 p2;// = body2->position + r2;
static Vec2 dp;// = p2 - p1;
...
static Vec2 dv;// = body2->velocity + Cross(body2->angularVelocity, r2) - body1->velocity - Cross(body1->angularVelocity, r1);
Vec2 impulse;
void Joint::ApplyImpulse()
{
    dv = body2->velocity + Cross(body2->angularVelocity, r2) - body1->velocity - Cross(body1->angularVelocity, r1);

...
iBOOL mwInitLevel007( void )
{
...
#if defined(PKIG_SCREEN_240X320)
			iVectInit2(&pos,(j)*8*COORDINATE_RATE+80*COORDINATE_RATE,(i)*8*COORDINATE_RATE+40*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_240X400)	
			iVectInit2(&pos,(j)*8*COORDINATE_RATE+80*COORDINATE_RATE,(i)*8*COORDINATE_RATE+40*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_320X480)	
			iVectInit2(&pos,(j)*8*COORDINATE_RATE+150*COORDINATE_RATE,(i)*8*COORDINATE_RATE+45*COORDINATE_RATE);
	...
	mwLevelDrawBKwall();
	//i51KitG2DrawImage(mwContainer, MudLevel007, iNULL, iNULL);
	//i51KitG2DrawImage(mwContainer, RockLevel007, iNULL, iNULL);

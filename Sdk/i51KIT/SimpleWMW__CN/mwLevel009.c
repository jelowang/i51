...
iBOOL mwInitLevel009( void )
{
...
#if defined(PKIG_SCREEN_240X320)
			iVectInit2(&pos,90*COORDINATE_RATE+j*8*COORDINATE_RATE,(i)*8*COORDINATE_RATE+20*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_240X400)	
			iVectInit2(&pos,93*COORDINATE_RATE+j*6*COORDINATE_RATE,(i)*6*COORDINATE_RATE+20*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_320X480)	
			iVectInit2(&pos,127*COORDINATE_RATE+j*8*COORDINATE_RATE,(i)*8*COORDINATE_RATE+43*COORDINATE_RATE);
	...
	mwLevelDrawBKwall();
	SWMW_i51KitG2DrawImage(&iMageInfo[MudLevel009], iNULL, iNULL);
	SWMW_i51KitG2DrawImage(&iMageInfo[RockLevel009], iNULL, iNULL);

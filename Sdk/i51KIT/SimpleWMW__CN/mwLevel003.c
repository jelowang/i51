...
iBOOL mwInitLevel003( void )
{
...
#if defined(PKIG_SCREEN_240X320)
			iVectInit2(&pos,(j)*4*COORDINATE_RATE+90*COORDINATE_RATE,(i)*4*COORDINATE_RATE+35*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_240X400)	
			iVectInit2(&pos,(j)*4*COORDINATE_RATE+90*COORDINATE_RATE,(i)*4*COORDINATE_RATE+35*COORDINATE_RATE);

#elif defined(PKIG_SCREEN_320X480)	
			iVectInit2(&pos,(j)*4*COORDINATE_RATE+140*COORDINATE_RATE,(i)*4*COORDINATE_RATE+55*COORDINATE_RATE);
	...
	mwLevelDrawBKwall();
	SWMW_i51KitG2DrawImage(&iMageInfo[MudLevel003], iNULL, iNULL);
	SWMW_i51KitG2DrawImage(&iMageInfo[RockLevel003], iNULL, iNULL);

...
extern iS32 i51KernelFormatVersion ( char* ver );

//	子版本号，MTK、MSTAR、SPRD、或其他平台小组用于跟踪问题的版本号。
//	该版本号的变化一搬发生在修改BUG后。
//	最大值1023
#define i51_ADE_CNF_IMP_VERSION "1"
char    *i51AdeImpVerStr = i51_ADE_CNF_IMP_VERSION;
